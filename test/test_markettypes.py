...
class TestOrder(unittest.TestCase):
    ...
    def test_orderid(self):
        ...
        self.assertNotEquals(o1.orderid, o2.orderid)
    ...
    def test_side(self):
        ...
        self.assertEquals(o1.side, Side.BUY)
        self.assertEquals(o2.side, Side.SELL)
    ...
    def test_price(self):
        ...
        self.assertEquals(o1.price, 4.5)
        self.assertEquals(o2.price, 0.0)
    ...
    def test_volume(self):
        ...
        self.assertEquals(o1.volume, 10)
        self.assertEquals(o2.volume, 0)
        self.assertRaises(AssertionError, Order, 0, Side.BUY, 4.5, -10)
